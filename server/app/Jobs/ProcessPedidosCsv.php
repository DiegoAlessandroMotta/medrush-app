      ...
      foreach ($csv->getIterator() as $indexInChunk => $record) {
        ...
        if ($validator->fails()) {
          ...
          if ($validatedData['ubicacion_recojo'] !== null) {
            $validatedData['ubicacion_recojo'] = AsPoint::toPostgreSqlRawExpression(AsPoint::pointFromArray($validatedData['ubicacion_recojo']));
          } else {
            $validatedData['ubicacion_recojo'] = AsPoint::toPostgreSqlRawExpression(AsPoint::pointFromArray($this->ubicacionRecojo));
          }

          if (isset($validatedData['ubicacion_entrega']) && $validatedData['ubicacion_entrega'] !== null) {
            $validatedData['ubicacion_entrega'] = AsPoint::toPostgreSqlRawExpression(AsPoint::pointFromArray($validatedData['ubicacion_entrega']));
          } else {
